...
[_NUMERIC] = LAYOUT(
  ...
  _______,  _______,  _______,  XXXXXXX,  XXXXXXX,  KC_CALC,                        KC_PSLS,    KC_P7,    KC_P8,    KC_P9,  KC_PMNS,  _______,
  _______,  KC_COMM,   KC_DOT,   KC_DLR,  KC_PERC,  KC_PEQL,                        KC_PAST,    KC_P4,    KC_P5,    KC_P6,  KC_PPLS,  _______,
  _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,    _______,    KC_P0,    KC_P1,    KC_P2,    KC_P3,  XXXXXXX,  _______,
                      KC_LGUI,  KC_LALT, KC_LCTRL, KC_LOWER,   KC_SPC,     KC_ENT, KC_RAISE, KC_RCTRL,  KC_RALT,  KC_RGUI
),
...
[_LOWER] = LAYOUT(
  ...
  _______,  XXXXXXX,  KC_PERC,  KC_TILD,   KC_GRV,   KC_DLR,                        KC_PIPE,  KC_COLN,   KC_EQL,  XXXXXXX,  XXXXXXX,   KC_F12,
  _______,  KC_EXLM,  KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,                        KC_LBRC,  KC_RBRC,  KC_SLSH,  KC_AMPR,  KC_QUES,   KC_DQT,
  _______,    KC_AT,  KC_HASH,  KC_MINS,  KC_LPRN,  KC_RPRN,  _______,    _______,  KC_LABK,  KC_RABK,  KC_ASTR,  KC_CIRC,  KC_BSLS,  _______,
...
[_RAISE] = LAYOUT(
  ...
  _______,   KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX,  XXXXXXX,                        KC_PGUP, KC_PRVWD,    KC_UP, KC_NXTWD, KC_DLINE,KC_BSPC_DEL,
  _______,  KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX,  KC_CAPS,                        KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,   KC_DEL,KC_BSPC_DEL,
...
[_ADJUST] = LAYOUT(
  ...
  XXXXXXX,  XXXXXXX,  CG_TOGG, KC_NUMER,  XXXXXXX,  XXXXXXX,                       XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX,
