...
[_LOWER] = LAYOUT(
  ...
  _______,   KC_EQL,  KC_MINS,  KC_PLUS,  KC_LCBR,  KC_RCBR,  _______,    _______,  KC_LBRC,  KC_RBRC,  KC_SLSH,  KC_QUES,  KC_BSLS,  KC_PIPE,
...
[_NUMERIC] = LAYOUT(
  _______,  _______,  _______,  _______,  _______,  _______,                        _______,  _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  XXXXXXX,  XXXXXXX,                        _______,     KC_7,     KC_8,     KC_9,  _______,  _______,
  _______,  _______,  _______,  _______,  XXXXXXX,  _______,                        _______,     KC_4,     KC_5,     KC_6,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  XXXXXXX,  _______,    _______,     KC_0,     KC_1,     KC_2,     KC_3,  _______,  _______,
                      _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______
),
